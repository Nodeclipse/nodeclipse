 ...
 * target container. The wizard creates one file with the extension "js". If a
...
public class NodejsFileWizard extends Wizard implements INewWizard {
    ...
    private void throwCoreException(String message) throws CoreException {
        IStatus status = new Status(IStatus.ERROR, "org.nodeclipse.ui", IStatus.OK, message, null);
